...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 u0x020002d5, ; uint32_t android_runtime_jnienv_class_token
	i32 u0x06001cda, ; uint32_t jnienv_initialize_method_token
	i32 u0x06001cd9, ; uint32_t jnienv_registerjninatives_method_token
...
@aot_dso_cache = dso_local local_unnamed_addr global [828 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x05a4cc144f74d5bc, ; from name: aot-EcoWay.so
		i64 u0x6ed8fbeef0ab134e, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-EcoWay.dll.so
		ptr null; void* handle
	}, ; 17
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x4ed2482d18648d7c, ; from name: EcoWay.so
		i64 u0x6ed8fbeef0ab134e, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-EcoWay.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0x5e53eaf4ddf11cc9, ; from name: aot-EcoWay.dll.so
		i64 u0x6ed8fbeef0ab134e, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-EcoWay.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0x6ed8fbeef0ab134e, ; from name: libaot-EcoWay.dll.so
		i64 u0x6ed8fbeef0ab134e, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-EcoWay.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0xaffad05ee79d109c, ; from name: libaot-EcoWay.so
		i64 u0x6ed8fbeef0ab134e, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-EcoWay.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0xb763a2a895605693, ; from name: EcoWay
		i64 u0x6ed8fbeef0ab134e, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-EcoWay.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0xe0fdbbefcdc67c7c, ; from name: libaot-EcoWay
		i64 u0x6ed8fbeef0ab134e, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-EcoWay.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0xf389568deae709d5, ; from name: aot-EcoWay
		i64 u0x6ed8fbeef0ab134e, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-EcoWay.dll.so
	...
	%struct.DSOCacheEntry {
		i64 u0xfea2a5ad9469d033, ; from name: EcoWay.dll.so
		i64 u0x6ed8fbeef0ab134e, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.8_name, ; name: libaot-EcoWay.dll.so
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [18 x i8] c"com.group6.ecoway\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [21 x i8] c"libaot-EcoWay.dll.so\00", align 16
