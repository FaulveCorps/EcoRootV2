...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [126 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 12474256; uint32_t buffer_offset
	}, ; 123: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 22048, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 12645264; uint32_t buffer_offset
	}, ; 124: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2037248, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 12667312; uint32_t buffer_offset
	} ; 125: Mono.Android
], align 16

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 14704560, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [14704560 x i8] zeroinitializer, align 16
